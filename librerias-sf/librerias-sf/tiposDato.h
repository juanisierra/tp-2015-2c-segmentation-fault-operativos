...
typedef enum{LISTO, EJECUTANDO, BLOQUEADO , AFINALIZAR,INVALIDO}estado_t; //INVALIDO es si alguna instruccion no estaba bien.
  ...
  typedef struct mensaje_CPU_PL_t
  {
	  ...
	  uint32_t tamMensaje; // Depende de la cantidad de instrucciones ejecutadas
	  char*payload;
  } mensaje_CPU_PL;
